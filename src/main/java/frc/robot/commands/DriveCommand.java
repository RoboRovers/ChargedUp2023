...
try{
    Thread.sleep(100);
     ...
     SwerveSubsystem.frontLeftModule.turningPidController.setI(0);
     SwerveSubsystem.frontRightModule.turningPidController.setI(0);
     SwerveSubsystem.backLeftModule.turningPidController.setI(0);
     SwerveSubsystem.backRightModule.turningPidController.setI(0);

     SwerveSubsystem.frontLeftModule.turningPidController.setD(0);
     SwerveSubsystem.frontRightModule.turningPidController.setD(0);
     SwerveSubsystem.backLeftModule.turningPidController.setD(0);
     SwerveSubsystem.backRightModule.turningPidController.setD(0);
